...
We hope this vignette has been helpful for getting started with organizing your input data and how to view and interpret results. Check out our other vignettes to view examples of other samplers, including using [informative priors](Xcertianty_informative_priors.html) 
and [growth curves](Xcertianty_growth_curves.html). 
