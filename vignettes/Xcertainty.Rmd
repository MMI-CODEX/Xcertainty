...
## Build sampler
Now we will build a sampler. Here we use non-informative priors, which should be appropriate for most datasets -- but see the vignette *Xcertainty_informative_priors* for an example of using informative priors. We also set the altitudes (`image_altitude`) and object length measurements (`object_lengths`) to cover an overly wide range for our target species.  
```{r}
