...
```{r, posterior_vs_obs_alt, fig.dim = c(7, 5)}
...
```{r, TL_per_subject, fig.dim = c(7, 5)}
output$summaries$objects %>% filter(Measurement == "TL_px") %>% 
  ggplot() + theme_bw() + 
...
```{r, std_widths_all, fig.dim = c(7, 5)}
